...
TVMStatus VMStart(int tickms, int argc, char *argv[]){
    ...
    VMThreadCreate(AlarmCallback, NULL, 0x100000, VM_THREAD_PRIORITY_NORMAL,&mainID); //create main thread (TID incremented)
    VMThreadCreate(IdleCallback, NULL, 0x100000, ((TVMThreadPriority)0x00), &idleID); //create Idle thread
